<script>
        ...
        var retry = 0;
            ...
            if (WacomGSS.STU.isServiceReady()) {
                ...
                if (retry < 20) {
                setTimeout(checkForSigCaptX, 1600);
                }
                else {
            ...
            setTimeout(checkForSigCaptX, 2500);
            ...
            .then(function (message) {
                if (message == null || message.length == 0) {
                    throw new Error("Nessuna Tavoletta Wacom Collegata!");
            ...
            m_btns[0].Text = "OK";
            m_btns[1].Text = "Pulisci";
            m_btns[2].Text = "Annulla";
