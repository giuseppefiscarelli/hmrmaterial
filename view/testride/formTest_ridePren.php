            ...
            <div class="col-12">
                <div class="card " style="    background-color: #dee2e68c;">
                    <div class="card-header card-header-success card-header-icon" >
                        ...
                        <h3 class="card-title"><?=$id?'Modifica':'Inserimento'?> Prenotazione Test Ride</h3>
                                    ...
                                    <div class="card-body ">
                                        <div class="row">
                                            <div class="col-lg-4 col-12">
                                                <p>Procedura Prenotazione<span class="float-right"><b class="procedura">0%</b></span></p>
                                            ...
                                            <div class="col-lg-4 col-12">
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td id="attCliente"><i aria-hidden="true" class="fa fa-<?=$tr['id_cliente']||$tr['note_pren']?'check':'ban'?>" style="color:<?=$tr['id_cliente']||$tr['note_pren']?'green':'red'?>;"></i> Dati Cliente / Note prenotazione</td>
                                                                <td></td>
                                                            </tr>
                                                            <tr>
                                            ...
                                            <div class="col-lg-4 col-12">
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td id="attVeicolo"><i aria-hidden="true" class="fa fa-<?=$tr['id_veicolo']||$tr['note_pren']?'check':'ban'?>" style="color:<?=$tr['id_veicolo']||$tr['note_pren']?'green':'red'?>;"></i> Scelta veicolo</td>
                                                                <td></td>
                                                            </tr>
                                                            <tr>
                            ...
                            <div class="col-xl-6 col-sm-12">
                                <div class="card ">
                                    ...
                                    <div class="card-body ">
                                        ...
                                        <div class="form-group bmd-form-group">
                                            <label class="bmd-label-static">Note Prenotazione</label>
                                            <input type="text" form="addform" class="form-control"id="note_pren" name="note_pren" value="<?=$id?$tr['note_pren']:''?>"placeholder="Inserisci note Prenotazione">
                                        </div>
                                                    ...
                                                    <div class="card ">
                                                        <div class="card-header card-header-warning card-header-icon" >
                                                            <div class="card-icon" >
                                                                ...
                                                                <h4 class="card-title">Calandario Prenotazioni</h4>
                                                        </div>
                                                        <div class="card-body ">
                                                            <div id="calendar"></div>
                                                        </div>
                                ...
                                <div class="card ">
                                    ...
                                    <div class="card-body ">
                                        <form enctype="multipart/form-data" id="addform" action="controller/updateTestride.php" method="post">   
                                            ...
                                            <input type="hidden" name="action" value="savePrenotazione">
                                            <div class="form-row">
                                            ...
                                            <div class="form-group col-xl-8 bmd-form-group">
                                                ...
                                                <select class="form-control selectpicker" title="Seleziona un modello" data-style="btn btn-link" id="id_veicolo" name="id_veicolo">
                                                    ...
                                                    <option data-content='<span class="badge m-1" style="background-color:<?=$m['colore_tr']?>"><i class="fa fa-motorcycle"></i> </span> <?=$m['marca']?> <?=$m['modello']?> <?=$m['targa']?>' value="<?=$m['targa']?>" <?=$id&&$tr['id_veicolo']==$m['targa']?'selected':''?>> </option>
                                                    <?php 
                                                        }
                                                    } ?>
                                                </select>
                                            ...
                                            <div class="row"> 
                                                <div class="col-lg-4 col-12">      
                                                    <div class="form-group  bmd-form-group">
                                                        <label for="km_cons">KM</label>
                                                        <input type="number" class="form-control" style="text-align: center;" id="km_cons" name="km_cons" value="<?=$id?$tr['km_cons']:''?>" />
                                                    </div>
                                                    
                                                    <div class="form-group   bmd-form-group">
                                                        <label for="ora_pren">Data Test</label>
                                                        <input type='date' class="form-control " min="<?=date("Y-m-d")?>"id="data_pren" name="data_pren" value="<?=$id?date("Y-m-d",strtotime($tr['data_pren'])):''?>"/>
                                                    
                                                        
                                                    </div>
                                                    <div class="form-group   bmd-form-group">
                                                        <label for="ora_pren">Ora Test</label>
                                                            <input type='time' class="form-control " min="08:00" max="20:00"id="ora_pren" name="ora_pren" value="<?=$id?date("H:i",strtotime($tr['data_pren'])):''?>"/>
                                                    
                                                        
                                                    </div>
                                                    <div class="form-group  bmd-form-group">
                                                        <label for="durata_test">Durata</label>
                                                        <select class="form-control selectpicker" data-style="btn btn-link" title="Seleziona Durata"id="durata_test" name="durata_test">
                                                           
                                                        
                                                            <option value="30" <?=$id&&$tr['durata_test']=='30'?'selected':''?>>30 minuti</option>
                                                            <option value="60" <?=$id&&$tr['durata_test']=='60'?'selected':''?>>1 ora</option>
                                                            <option value="90" <?=$id&&$tr['durata_test']=='90'?'selected':''?>>1 ora e 1/2</option>
                                                            <option value="120" <?=$id&&$tr['durata_test']=='120'?'selected':''?>>2 ore</option>
                                                            <option value="800" <?=$id&&$tr['durata_test']=='800'?'selected':''?>>Intera giornata</option>
                                                            <option value="1000" <?=$id&&$tr['durata_test']=='1000'?'selected':''?>>Lungo Termine</option>
                                                            
                                                        
                                                        </select>
                                                    
                                                    </div>
                                                    <div class="form-group   bmd-form-group lungotermine" style="display:none;">
                                                        <label for="data_ricons">Data Riconsegna</label>
                                                        <input type='date' class="form-control " min="<?=date("Y-m-d")?>"id="data_ricons" name="data_ricons" value=""/>
                                                    
                                                        
                                                    </div>
                                                    <div class="form-group   bmd-form-group lungotermine"style="display:none;">
                                                        <label for="ora_ricons">Ora Riconsegna</label>
                                                            <input type='time' class="form-control " min="08:00" max="20:00"id="ora_ricons" name="ora_ricons"/>
                                                    
                                                        
                                                    </div>
                                                    <div class="form-group  bmd-form-group">
                                                        <label for="durata_test">Disponibilità</label>
                                                        <input type="hidden" id="ck_disp" name="ck_disp" value="<?=$id?'1':'0'?>">
                                                        <span id="span_ck"class="badge badge-<?=$id?'success':'warning'?>"><?=$id?'prenotazione Effettuata':'Seleziona Veicolo, Data e Ora'?></span>
                    ...
                    <div class="card-footer " style="justify-content: center;background-color: white;padding: 10px;border-radius: 6px;box-shadow: 0 1px 4px 0 rgba(0, 0, 0, 0.14);">
                        <button type="submit" form="addform"id="saveTest" disabled class="btn btn-success">Inserisci Prenotazione</button>
