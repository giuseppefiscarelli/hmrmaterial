 ...
 */
require_once $_SERVER['DOCUMENT_ROOT'].$pathAlle.'vendor/autoload.php';
require_once $_SERVER['DOCUMENT_ROOT'].$pathAlle.'model/anagr_cli.php';
require_once $_SERVER['DOCUMENT_ROOT'].$pathAlle.'unctions.php';
