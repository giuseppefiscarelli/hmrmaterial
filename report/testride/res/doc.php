...
<style type="text/css">
    ...
    <page_footer>
        <table class="page_footer">
            <tr>
				...
				<em style="font-size:10px;">Report TestRide DocumentoHMR - ver 1.0</em>
                </td>
    ...
    <h4 style="text-align:center">Patente di guida</h4>
<br>
<table>
...
<BR><BR><br>
<img src="<?=$_SERVER['DOCUMENT_ROOT']?>ERP/HMR/docs/CRM/Allegati/patente/<?=$cli['id']?>_patfront.jpg" style="height: 54mm;padding: 25px;"><br><br><br>
<div style="height:20mm"></div>
<img src="<?=$_SERVER['DOCUMENT_ROOT']?>ERP/HMR/docs/CRM/Allegati/patente/<?=$cli['id']?>_patrear.jpg" style="height: 54mm;padding: 25px;"><br>
