...
<table>
	<tbody>
		...
		<tr>
			<td></td>
		 <?php if(file_exists($_SERVER['DOCUMENT_ROOT'].$pathAlle."docs/testride/sign/".$cli['id']."_sig_cons_tr_".$tr['id'].".png")){?>
			<td>	<img src="<?=$_SERVER['DOCUMENT_ROOT'].$pathAlle?>docs/testride/sign/<?=$cli['id']?>_sig_cons_tr_<?=$tr['id']?>.png" style="width:65mm;text-align:center;">
